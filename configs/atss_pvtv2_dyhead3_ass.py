_base_ = [
    ...
    '_base_/datasets/pest24.py',
    '_base_/schedules/schedule_1x.py',
    '_base_/default_runtime.py'
]
model = dict(
    type='ATSS',
    pretrained='/root/haidm/pest-pvt-haidm/pretrained/pvt_v2_b2.pth',
    backbone=dict(
        type='pvt_v2_b2',
        style='pytorch'),
    neck=[dict(
...
# To re-enable Apex AMP later, restore the original block:
#   runner = dict(type='EpochBasedRunnerAmp', max_epochs=100)
#   fp16 = None
#   optimizer_config = dict(type="DistOptimizerHook", ...)
